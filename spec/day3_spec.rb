...
describe Day3 do
  describe "#min_distance" do
    it "returns the shortest distance to the center for any intersection points of two lines" do
      expect(subject.min_distance(%w[R75 D30 R83 U83 L12 D49 R71 U7 L72],
                                  %w[U62 R66 U55 R34 D71 R55 D58 R83])).to eq 159
      expect(subject.min_distance(%w[R98 U47 R26 D63 R33 U87 L62 D20 R33 U53 R51],
  ...
  describe "#min_steps" do
    it "returns the fewest combined steps the wires must take to reach an intersection" do
      expect(subject.min_steps(%w[R75 D30 R83 U83 L12 D49 R71 U7 L72],
                               %w[U62 R66 U55 R34 D71 R55 D58 R83])).to eq 610
      expect(subject.min_steps(%w[R98 U47 R26 D63 R33 U87 L62 D20 R33 U53 R51],
                               %w[U98 R91 D20 R16 D67 R40 U7 R15 U6 R7])).to eq 410
    end
  end
